...
import { PerfileditService } from 'src/app/componentes/administrar/editarprecios/perfiledit.service';
...
export class ManagementComponent implements OnInit {
  ...
  agregaUsuario() {
    ...
    this.ocultarTable = !this.ocultarTable;
  }
